...
class KnowledgeBaseService:
    ...
    def __init__(self, kb_id: str = "default") -> None:
        ...
        os.makedirs(config.persist_director, exist_ok=True)
        self.persist_director = os.path.join(config.persist_director, kb_id)
        os.makedirs(self.persist_director, exist_ok=True)

        self.parent_store_path = os.path.join(
            config.persist_director, kb_id, "parent_store.json"
        )
        ...
        self.chroma = Chroma(
            ...
            persist_directory=self.persist_director,
        )
